const ru = {
  ...
  notAcceptedWarning:
    "{count} предмет(ов) в вашем списке сейчас не принимаются. Проверьте детализацию ниже и удалите их перед созданием контракта.",
  ...
  janiceAppraisalLink: "Открыть оценку Janice",
